            ...
            try (PDPageContentStream contentStream2 = new PDPageContentStream(
                ...
                if(data.getComplaint_category_code().equals("AA001")) {
                    ...
                    if(data.getAllInclude().equals("Y")){
                        ...
                        //writeText(document,page,checkedOrEmpty(data.getInclude_occurrence_date(),check),font,397 ,580); //변동 사유
                        ...
                        writeText(document,page,check2,font,443 ,536); //세대
                        writeText(document,page,check2,font,490 ,536); //세대원

                        writeText(document,page,check,font,504 ,514); // 세대원의 세대주와의 관계

                        writeText(document,page,check,font,504 ,493); // 동거인
                    }
                }else {
                    ...
                    if(data.getAllInclude().equals("Y")){
                        ...
                        writeText(document,page,check,font,504 ,471); // 개인 인적사항 변경 내용

                        writeText(document,page,check,font,315 ,445); //과거의 주소 변동 사항 전체
                        writeText(document,page,check,font,395 ,445); //직접입력
                        writeText(document,page,check,font,496 ,445); //_년 포함

                        writeText(document,page,check,font,504 ,424); // 개인 인적사항 변경 내용

                        writeText(document,page,check,font,504 ,405); // 주민등록번호 뒷자리

                        writeText(document,page,check,font,504 ,386); // 세대주의 성명과 세대주와의 관계

                        writeText(document,page,check,font,504 ,368); // 발생일 / 신고일
